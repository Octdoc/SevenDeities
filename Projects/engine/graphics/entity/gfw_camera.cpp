#include "gfw_camera.h"

namespace gfw
{
	Camera::Camera() : m_screenAspect(0.0f), m_fieldOfView(0.0f), m_screenDepth(0.0f), m_screenNear(0.0f) {}
	void Camera::Init(float screenAspect, float fov, float screenNear, float screenDepth)
	{
