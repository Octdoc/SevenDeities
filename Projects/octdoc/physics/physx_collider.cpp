...
#pragma region Collider
		...
		Collider::Collider(gfx::ModelLoader& modelLoader)
		{
			CreateCollider(modelLoader);
		}
		Collider::Collider(gfx::ModelLoader& modelLoader, mth::float3 position)
		{
			this->position = position;
			CreateCollider(modelLoader);
		}
		Collider::P Collider::Create(gfx::ModelLoader& modelLoader)
		{
			return std::make_shared<Collider>(modelLoader);
		}
		Collider::P Collider::Create(gfx::ModelLoader& modelLoader, mth::float3 position)
		{
			return std::make_shared<Collider>(modelLoader, position);
		}
		void Collider::CreateCollider(gfx::ModelLoader& modelLoader)
		{
